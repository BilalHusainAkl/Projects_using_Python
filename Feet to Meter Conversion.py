# Project for Feet to Meter Conversion
# Developer: Bilal Husain
...
#labels for feet
ft_lbl = Label(window, text='Feet', bg='silver', fg='white',width=34)
ft_lbl.grid(column=0, row=0, padx=15, pady=15)

# entery widget for feet
ft_value=DoubleVar()
ft_entry=Entry(window, textvariable=ft_value, width=34)
ft_entry.grid(column=1, row=0)
ft_entry.delete(0,'end')

#label for meter
mt_lbl=Label(window, text='Meter', bg='silver',fg='white',width=34)
mt_lbl.grid(column=0, row=1)

#enetry widget for meter
mt_value=DoubleVar()
mt_entry=Entry(window, textvariable=mt_value,width=34)
mt_entry.grid(column=1,row=1,pady=30)
mt_entry.delete(0,'end')

#creating button for convert and clear
#convert
convert_btn = Button(window, text='Convert',bg='white',fg='black',width=34,command=convert)
convert_btn.grid(column=0,row=3,padx=15) 

#clear
clear_btn=Button(window, text='Clear',bg='white',fg='black',width=34,command= clear)
